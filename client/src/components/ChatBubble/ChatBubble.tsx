...
import { createConversation, getAllConversations, newMessage } from '../../redux/actions/Users'
...
export default function ChatBubble() {
    ...
    const conversations: Conversation[] = useAppSelector(state => state.conversations)
                ...
                <div className={styles.container} style={{ height: open }} ref={ref}>
                    <div className={styles.header} onClick={() => handleOpen()}>
                        <div className={styles.infoHeader}>
                            <img src={user.avatar && user.avatar?.length > 10 ? user.avatar : avatarDefault} alt="avatar" />
                            <h4>{user.name}</h4>
                        </div>
                    ...
                    </div>
                    {
                        ...
                        <>
                            ...
                            <div className={styles.boxtext}>
                                <input name="menssage" value={message.message} placeholder='Press ENTER' onFocus={() => newConversation()} onChange={(e) => handleWriteMessage(e)} onKeyUp={(e) => handleSendMessage(e)} />
                            </div>
